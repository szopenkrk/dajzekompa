/* Libraries */
import { lightGreen, lime, amber, orange, deepOrange, grey } from '@material-ui/core/colors';
...
export function getDeviceStatusColor (type: DeviceStatus): string {
    switch (type) {
        ...
        case DeviceStatus.SENT_TO_RECIPIENT: return lime[700];
        case DeviceStatus.COMPLETE: return lightGreen[700];
